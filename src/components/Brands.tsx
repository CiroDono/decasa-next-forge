const brands = ["Bosch", "DeWalt", "Lusqtoff", "Hamilton", "Bremen", "Total", "Milwaukee"];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4">
          {brands.map((b) => (
            <div
              key={b}
              className="aspect-[3/2] bg-surface border border-border rounded-xl flex items-center justify-center text-foreground/70 font-bold text-sm hover:border-accent hover:text-accent hover:shadow-card transition-all"
            >
              {b}
            </div>
          ))}
